...
1  como vai ser a estrutura do desafio
2 opções de challenges para você escolher e
3 conteúdo para aprender o básico de programação.
...
Enviar até 22/03 o arquivo do desafio para o administrador do grupo em que você foi encaixado
